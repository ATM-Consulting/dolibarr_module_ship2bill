...
class modShip2bill extends DolibarrModules
{
	...
	function __construct($db)
	{
        ...
        /* Example:
        if (! isset($conf->global->mymodule)) $conf->mymodule->enabled=0;	// This is to avoid warnings
        $this->dictionaries=array(
        ...
        */
		...
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=products,fk_leftmenu=sendings',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								...
								'perms'=>'$user->rights->ship2bill->read && $user->rights->expedition->lire',			                // Use 'perms'=>'$user->hasRight("mymodule", "level1", "level2")' if you want your menu with a permission rules
								'target'=>'',
