...
print $form->selectyesno("SHIP2BILL_ADD_SHIPMENT_AS_TITLES",getDolGlobalString('SHIP2BILL_ADD_SHIPMENT_AS_TITLES'),1);
...
if(!empty($conf->subtotal->enabled)) {
	...
	print $form->selectyesno("SHIP2BILL_ADD_SHIPMENT_SUBTOTAL",getDolGlobalString('SHIP2BILL_ADD_SHIPMENT_SUBTOTAL'),1);
	print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
	print '</form>';
	print '</td></tr>';
}
...
print $form->selectyesno("SHIP2BILL_CLOSE_SHIPMENT",getDolGlobalString('SHIP2BILL_CLOSE_SHIPMENT'),1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectarray("SHIP2BILL_INVOICE_PER_SHIPMENT", $TBillingType, getDolGlobalString('SHIP2BILL_INVOICE_PER_SHIPMENT'));
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SHIP2BILL_GET_SERVICES_FROM_ORDER",getDolGlobalString('SHIP2BILL_GET_SERVICES_FROM_ORDER'),1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SHIP2BILL_VALID_INVOICE",getDolGlobalString('SHIP2BILL_VALID_INVOICE'),1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SHIP2BILL_CLASSYFIED_PAYED_ORDER",getDolGlobalString('SHIP2BILL_CLASSYFIED_PAYED_ORDER'),1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectarray('SHIP2BILL_GENERATE_INVOICE_PDF', $liste, getDolGlobalString('SHIP2BILL_GENERATE_INVOICE_PDF'), 1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
if(getDolGlobalString('SHIP2BILL_GENERATE_INVOICE_PDF') && getDolGlobalString('SHIP2BILL_GENERATE_INVOICE_PDF') != -1 && strpos(getDolGlobalString('SHIP2BILL_GENERATE_INVOICE_PDF'), 'generic_invoice_odt') === false) {
	...
	print $form->selectyesno("SHIP2BILL_GENERATE_GLOBAL_PDF",getDolGlobalString('SHIP2BILL_GENERATE_GLOBAL_PDF'),1);
	print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
	print '</form>';
	print '</td></tr>';
}
...
print $form->selectyesno("SHIP2BILL_USE_DEFAULT_BANK_IN_INVOICE_MODULE",getDolGlobalString('SHIP2BILL_USE_DEFAULT_BANK_IN_INVOICE_MODULE'),1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SHIP2BILL_DISPLAY_ORDERCUSTOMER_IN_TITLE",getDolGlobalString('SHIP2BILL_DISPLAY_ORDERCUSTOMER_IN_TITLE'),1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SHIP2BILL_CHECKED_BY_DEFAULT",getDolGlobalString('SHIP2BILL_CHECKED_BY_DEFAULT'),1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno("SHIP2BILL_MULTIPLE_EXPED_ON_BILL_THIRDPARTY_CARD",getDolGlobalString('SHIP2BILL_MULTIPLE_EXPED_ON_BILL_THIRDPARTY_CARD'),1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
...
print $form->selectyesno('SHIP2BILL_DISPLAY_SHIPMENT_REAL_DATE', getDolGlobalString('SHIP2BILL_DISPLAY_SHIPMENT_REAL_DATE'), 1);
print '<input type="submit" class="button" value="'.$langs->trans('Modify').'">';
print '</form>';
print '</td></tr>';
