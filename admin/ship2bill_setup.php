...
$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>'.$langs->trans("ShipmentInvoiceOnlyShippingProducts").'</td>';
print '<td align="center" width="20">&nbsp;</td>';
print '<td align="right" width="300">';
print '<form method="POST" action="'.$_SERVER['PHP_SELF'].'">';
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';
print '<input type="hidden" name="action" value="set_SHIPMENT_GETS_ALL_ORDER_PRODUCTS">';
print $form->selectyesno("SHIPMENT_GETS_ALL_ORDER_PRODUCTS",$conf->global->SHIPMENT_GETS_ALL_ORDER_PRODUCTS,1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
